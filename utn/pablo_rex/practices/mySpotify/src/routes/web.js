...
const { getWelcomePage, getRegisterPage, getLoginPage, getYoutubePage, getDashboardPage, getSpotyPage } = require("@controllers/webController");
...
router.get("/spoty", authMiddleware, getSpotyPage);
